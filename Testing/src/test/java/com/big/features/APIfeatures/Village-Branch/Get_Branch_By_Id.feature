...
Background:
    ...
    * def subpath = '/branch/1'
    # Getting Token Data
    #* def resp = call read('GetToken.feature')
    #* def token = resp.token--Removed my me
    # Reading Saved Data
    ...
    * def ExpectedResponseTime_BranchId = jsonPayload.ExpectedResponseTime_BranchId
    ...
    * print Connection
    * print tokenInvalid
    * print ExpectedResponseTime_BranchId
    * print Accept
  ...
  Scenario: 6 Check for responseTime and compare with expected response time - [ResponseTime]
    ...
    * print ExpectedResponseTime_BranchId
    # Matching response data
    * assert responseTime <= ExpectedResponseTime_BranchId
